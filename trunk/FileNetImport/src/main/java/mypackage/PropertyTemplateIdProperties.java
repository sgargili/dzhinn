...
@XmlRootElement(name = "PropertyTemplateIdProperties")
public class PropertyTemplateIdProperties {
    ...
    @XmlElement(name = "PropertyDefaultId", required = true)
    protected String propertyDefaultId;
    ...
    /**
     * Gets the value of the propertyDefaultId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     ...
     *     
     */
    public void setPropertyDefaultId(String value) {
        this.propertyDefaultId = value;
    }
