 ...
 *         &lt;element ref="{}PropertyDefaultBoolean"/>
...
@XmlRootElement(name = "PropertyTemplateBooleanProperties")
public class PropertyTemplateBooleanProperties {
    ...
    @XmlElement(name = "PropertyDefaultBoolean", required = true)
