...
import convertors.XmlConvertor4Art2Composite;
...
public class AttributesXML {
    ...
    private void initXstream() {
        ...
        xstream.alias("Composite", boolean.class);
    ...
    public String getAttributesWithCompositeByGroupeId(int groupeId) {
        List out = fd.getAttributeDAO().getAttributesWithCompositByGroupeIdByNatveSQL(groupeId);
//        initXstream();
        xstream.registerConverter(new XmlConvertor4Art2Composite());
