...
dojo.byId("texta").value = divold;
		...
		// Это для чекера при вводе пароля...
		function checkfx() {
		...
		dojo.addOnLoad(function() {
			...
			dojo.byId('newtd').innerHTML += " готово!";
...
<body class="tundra">
	...
	<!-- basic preloader: -->
	<div id="loader"><div id="loaderInner"><table><tr><td><img src="../dojox.png"></td></tr><tr><td id = "newtd">&#160;&#160;&#160;&#160;&#160;&#160;&#160;Загрузка системы Tools for <b><i><font color="#020298">Value</font><font color="#e78403">4</font><font color="#020298">IT</font></i></b> ...</td></tr></table></div></div>
	...
	<div id="main" dojoType="dijit.layout.BorderContainer">
		<div id="loaderInner1" dojoType="dijit.layout.ContentPane" region="top"><table width=100%><tr><td><b><font color=white>Система быстрого экспорта для <i><font color="#020298">Value</font><font color="#e78403">4</font><font color="#020298">IT</font></i> и других тулов... </font></b></td><td align=right>
		<img src="../dojox1.png">
		<div dojoType="dijit.form.DropDownButton">
					<span>Авторизация</span>
					<div dojoType="dijit.TooltipDialog" id="tooltipDlg1" title="Авторизация"
						...
						<table>
							...
							<tr>
								<td>Чужой компьютер:&#160;<input id="check44" type="checkBox" dojoType="dijit.form.CheckBox" onclick=checkfx()></td>
								<td colspan="2" align=right><button dojoType=dijit.form.Button type="submit" name="submit">Войти</button></td>
							</tr>
						</table>
					</div>
				</div> 
...
<input type=button onclick=qwerty(); value="Нажми чтобы посмареть">
			
			</div>
			</div>

			<div dojoType="dijit.layout.AccordionPane" title='<font size="2">Трафик</font>'>
				<!-- tree widget -->
			...
			<div dojoType="dijit.layout.AccordionPane" title='Администрирование' selected="false">
...
<td width=70%><textarea title="Введите значения Article или ArticleID" id='texta' name='programmaticTextArea'  style='width:100%; height:300px' onchange="dojo.byId('www').value = qSend();"></textarea></td>
<td width=1%>&#160;</td>
<td width=29% align=center>
	...
	<table align=center width=100%>
		<tr align=left>
			<td><input type='radio' name='datatype' id='g1rb234' value='ArticleID' dojoType='dijit.form.RadioButton' checked>
				<label for='g1rb234' title="Хуячит как барбос!"><b>ArticleID</b>&nbsp;(Шустро!)</label>
			</td>
			<td><input type='radio' name='datatype' id='g1rb134' value='Article' dojoType='dijit.form.RadioButton'>
				<label for='g1rb134' title="А этот не как барбос, но тоже шустрее чем Валуев4IT..."><b>Article</b>&nbsp;(По-медленее...)</label>
			</td>
		</tr>
	</table>
	</div>
	<div dojoType="dijit.TitlePane" title="Языки" style="width: 350px;" jsId="pane2" open="false">
		<div align=center>
			...
			<label for="cb1">По умолчанию</label>
</div>
<br>
	<table width=100%>
	<tr>
	...
	<table align=center width=100%>
		<tr align=left>
			<td><input type='radio' name='status' id='g1rb2345' value='Done' dojoType='dijit.form.RadioButton' checked>
				<label for='g1rb2345'><b>Только Done</b></label>
			</td>
			<td><input type='radio' name='status' id='g1rb1345' value='All' dojoType='dijit.form.RadioButton'>
				<label for='g1rb1345'><b>Пох...</b></label>
			</td>
		</tr>
	</table>	
	</div>
	<input dojoType=dijit.form.TextBox  id="www" name="newnew" type="hidden">
		<button dojoType=dijit.form.Button type="submit" name="submit" value="Export">Войти</button>
			...
			<table width=100%><tr valign=top>
<td width=70%><textarea title="Введите значения Article или ArticleID" id='texta' name='programmaticTextArea'  style='width:20px; height:100px'></textarea></td>
<td width=5%>&nbsp;</td>
<td width=25% align=right>
	
	<div dojoType="dijit.TooltipDialog" id="ssssaasasas" title="Авторизация"
						execute="alert(dojo.toJson(arguments[0], false));">
						<div dojoType="dijit.layout.AccordionContainer" id="Xfilters1">

		<div dojoType="dijit.layout.AccordionPane" title="Данные для экспорта" >
<div align=center> Чё ты ввёл? :)</div>
<br>
	<table align=center>
		<tr align=left>
			<td><input type='radio' name='g1341' id='g1rb2341' value='ArticleID' dojoType='dijit.form.RadioButton' checked>
				<label for='g1rb2341' title="Хуячит как барбос!"><b>ArticleID</b>&nbsp;(Шустро!)</label>
			</td>
		</tr>
		<tr align=left>
			<td><input type='radio' name='g1341' id='g1rb1341' value='Article' dojoType='dijit.form.RadioButton'>
				<label for='g1rb1341' title="А этот не как барбос, но тоже шустрее чем Валуев4IT..."><b>Article</b>&nbsp;(По-медленее...)</label>
			</td>
		</tr>
	</table>
		</div>
		<div dojoType="dijit.layout.AccordionPane" title="Языки">
		<div align=center>Языки экспорта
		</div>
		<br>
		<div align=center>
			<input name="cb11" id="cb11" value="English" dojoType="dijit.form.CheckBox" checked=true onclick="valid()">
			<label for="cb11">По умолчанию</label>
</div>
<br>
	<table>
	<tr>
	...
	<tr>
		...
		<div dojoType="dijit.layout.AccordionPane" title="Статус">

		</div>

	</div>
	<button dojoType=dijit.form.Button type="submit" name="submit">Войти</button>
					</div>
	</td>
</tr></table>
...
<table width=100%><tr>
<td width=70%><textarea title="Введите значения Article или ArticleID" id='texta' name='programmaticTextArea'  style='width:100%; height:300px'></textarea></td>
<td width=10></td>
...
<button dojoType="dijit.form.Button">
  ...
  <table style="margin:5px; padding:5px;"><tr width=100%><td>
      ...
      Reply: <span id="demoReply2" style="background:#eeffdd; padding-left:4px; padding-right:4px;">&nbsp;</span>
		...
		<div id="yuyuyu" dojoType="dojox.layout.ExpandoPane" region="bottom"  style='height: 93%' startExpanded="false" maxWidth="93%" title="Статистика"  >
		...
		<div dojoType="dijit.layout.TabContainer" id="bottomTabs" tabPosition="bottom" selectedChild="btab1" region="top" splitter="false" style='height: 98%'>
			...
			<!-- btab 1 -->
			<div id="btab1" dojoType="dijit.layout.ContentPane" title="Статистика Полностью" style=" padding:5px;" align=center>
...
<br><br><br>
			...
			<div id="btab2" dojoType="dijit.layout.ContentPane" title="Статистика Done" style="padding:20px;">
				<span id="themeData"></span>
			</div><!-- btab2 -->

			<div id="btab3" dojoType="dijit.layout.ContentPane" title="Чё упало, то пропало..." closable="true">
				<p>In process...</p>
