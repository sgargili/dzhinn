...
djd43.io.createIFrame = function (fname, onloadstr, uri) {
	...
	if (!turi) {
		if (djd43_config["useXDomain"] && !djd43_config["dojoIframeHistoryUrl"]) {
			djd43.debug("djd43.io.createIFrame: When using cross-domain Dojo builds," + " please save iframe_history.html to your domain and set djd43_config.dojoIframeHistoryUrl" + " to the path on your domain to iframe_history.html");
		}
		turi = (djd43_config["dojoIframeHistoryUrl"] || djd43.uri.moduleUri(djd43, "../iframe_history.html")) + "#noInit=true";
	}
