...
public class CsvWriter_1 {
	 ...
	 *            writing the data.
	 */
	public CsvWriter_1(String fileName, char delimiter, Charset charset) {
		if (fileName == null) {
	 ...
	 *            The path to the file to output the data.
	 */
	public CsvWriter_1(String fileName) {
	 ...
	 *            The character to use as the column delimiter.
	 */
	public CsvWriter_1(Writer outputStream, char delimiter) {
	 ...
	 *            writing the data.
	 */
	public CsvWriter_1(OutputStream outputStream, char delimiter, Charset charset) {
