...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="product">
        ...
        <xsl:apply-templates select="marketing" mode="product"/>
        <xsl:apply-templates select="link" mode="product"/>
        <table class="spec_table">
            <tbody>
                <xsl:apply-templates select="card" mode="product"/>
            </tbody>
        </table>
    </xsl:template>
    <xsl:template match="group" mode="product">
    ...
    <xsl:template match="marketing" mode="product">
        <div id="marketing">
