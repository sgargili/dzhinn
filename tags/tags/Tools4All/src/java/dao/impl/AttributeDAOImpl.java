...
//            atr.getRegexps().isEmpty();
    ...
    public List getAttributesOnlyByProductTypeIdByNativeSQL(final int id) {
        ...
        final String request =
                ...
                + "order by "
                + "    gp.groupe_name, atr.attribute_name";
    ...
    @Override
    public List getAttributesWithCompositByGroupeIdByNatveSQL(final int id) {
        List result = null;
        final String request =
                "    select "
                + "        atr.attribute_id, "
                ...
                + "    inner join "
                + "        composite as com "
                + "            on  com.attribute_id = atr.attribute_id "
                + "            and  com.groupe_id = gp.groupe_id "
                + "    inner join "
                + "        groupe2atr as g2a "
                + "            on     atr.attribute_id = g2a.attribute_id "
                + "            and gp.groupe_id = g2a.groupe_id "
                + "    where "
                + "        gp.groupe_id = :value "
                + "    order by "
                + "        atr.attribute_name";
    ...
    @Override
    public void updateCompositeOnly(final int atrId, final int groupeId) {
        final String request =
                "update "
                + "    composite  "
                + "set  "
    ...
    @Override
    public void addComposite(final int atrId, final int groupeId) {
        final String request =
                "insert "
                + "into "
                + "     composite "
                + "     (composite_value, attribute_id, groupe_id) "
                + "values "
                + "     (:bool, :atrId, :groupeId)";
        getHibernateTemplate().execute(new HibernateCallback() {
    ...
    @Override
    public boolean isCompositePresent(final int atrId, final int groupeId) {
        List result = null;
        final String request =
                "select "
                + "    com.composite_id "
                ...
                + "    composite as com "
                + "where "
                + "    com.attribute_id = :atrId "
                + "    and com.groupe_id = :groupeId";
        result = (List) getHibernateTemplate().execute(new HibernateCallback() {
    ...
    @Override
    public void updateCompositeRegexpElabType(final int atrId, final int groupeId) {
        final String request =
                "update "
                + "    composite  "
                + "set  "
