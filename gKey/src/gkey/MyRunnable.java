            ...
            try {
                ...
                try {
                    for (int i = 10001; i < 20000; i++) {
                        System.out.print("Поток 2 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 20001; i < 30000; i++) {
                        System.out.print("Поток 3 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 30001; i < 40000; i++) {
                        System.out.print("Поток 4 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 40001; i < 50000; i++) {
                        System.out.print("Поток 5 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 50001; i < 60000; i++) {
                        System.out.print("Поток 6 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 60001; i < 70000; i++) {
                        System.out.print("Поток 7 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 70001; i < 80000; i++) {
                        System.out.print("Поток 8 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 80001; i < 90000; i++) {
                        System.out.print("Поток 9 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
            ...
            try {
                ...
                try {
                    for (int i = 90001; i < 100000; i++) {
                        System.out.print("Поток 10 -> Продукт -> " + i);
                        if (j++ == 10) {
                            ip.setChange();
                            j = 1;
                            System.out.print(" Сменился IP...");
