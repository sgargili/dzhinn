...
//                }
                try {
                    ptpt.setProductsId((int) FactoryDAO4Imports.getInstance().getPcSyncProductsDAO().getPcSyncProductsByModel(reader.get(2).trim()));
                    ptpt.setPtId(FactoryDAO4Imports.getInstance().getPcProductTypesDAO().getPcProductTypesByName(reader.get(0).trim()));
                } catch (Exception e) {
...
//        }
        ...
        try {
            ...
            while (reader.readRecord()) {
                ...
                try {
                    ...
                    mtpt.setProductType(FactoryDAO4Imports.getInstance().getPcProductTypesDAO().getPcProductTypesByName(reader.get(0).trim()));
                } catch (Exception e) {
                    System.out.println(e);
                }
                if (!(mtpt.getIdManufacture() == 0) && !FactoryDAO4Imports.getInstance().getPcManufacturePtDAO().isPcManufacturePtPresent(mtpt.getIdManufacture(), mtpt.getProductType())) {
                    FactoryDAO4Imports.getInstance().getPcManufacturePtDAO().addPcManufacturePt(mtpt);
                    i++;
                }
            }
            System.out.println(i);
    ...
    public void updateMan() throws XmlPullParserException, IOException, SQLException {
        ...
        while (iterator.hasNext()) {
            ...
            FactoryDAO4Imports.getInstance().getManufacturersInfoDAO().addManufacturersInfo(minfo);
