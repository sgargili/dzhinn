...
public class fCreator {
    ...
    private String elabCSV(File fl, String type, String SupplierName) throws SQLException, IOException {
        if (type.equals("Supplier")) {
            elabCsvSupp exs = new elabCsvSupp();
            return exs.addSupplierPrice(fl);
        } else {
            if (type.equals("Matching")) {
                elabCsvMatch ecm = new elabCsvMatch();
                return ecm.addMatching(fl,SupplierName);
            }
            return "";
        }
    }
    ...
    public String writeToFile(String filename, InputStream strPage, String type, String SupplierName) throws ZipException, IOException, SQLException {
        ...
        if (m.find()) {
            ...
            if (m.find()) {
                ...
                if (m.find()) {
                    ...
                    temp = elabCSV(fl, type, SupplierName);
                }
            } else {
                re = "[.]xls$";
                p = Pattern.compile(re);
