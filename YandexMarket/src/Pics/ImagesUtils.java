 ...
 *
 * @author Rafael Steil
 * @version $Id: ImagesUtils.java,v 1.23 2007/09/09 01:05:22 rafaelsteil Exp $
 */
public class ImagesUtils {
     ...
     * @param type The image type. Use <code>ImagesUtils.IMAGE_JPEG</code> to save as JPEG images,
     *  or <code>ImagesUtils.IMAGE_PNG</code> to save as PNG.
     * @return <code>false</code> if no appropriate writer is found
     */
    public static boolean saveImage(BufferedImage image, File file, int type) throws IOException {
        try {
    ...
    public static BufferedImage createHeadlessBufferedImage(BufferedImage image, int type, int width, int height) {
        if (type == ImagesUtils.IMAGE_PNG && hasAlpha(image)) {
    ...
    public static BufferedImage createHeadlessSmoothBufferedImage(BufferedImage source, int type, int width, int height) {
        if (type == ImagesUtils.IMAGE_PNG && hasAlpha(source)) {
            type = BufferedImage.TYPE_INT_ARGB;
        } else {
            type = BufferedImage.TYPE_INT_RGB;
        }
